        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li><a className="text-base text-gray-500 hover:text-gray-900">Blog</a></li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-4">
              <li><a className="text-base text-gray-500 hover:text-gray-900">Contact</a></li>
              <li><a className="text-base text-gray-500 hover:text-gray-900">Shipping</a></li>
              <li><a className="text-base text-gray-500 hover:text-gray-900">Returns</a></li>
            </ul>
          </div>
          <div>
